...
if(message.content === "pls pee in my ass") {
    message.channel.send("pee in ur ass");
  }
  if(message.content === "Pls pee in my ass") {
    message.channel.send("pee in ur ass");
  }
  if(message.content === "pls pee in my ass") {
    message.channel.send("https://cdn.discordapp.com/attachments/835877241292455966/1030533060678123572/unknown.png");
  }
  if(message.content === "Pls pee in my ass") {
    message.channel.send("https://cdn.discordapp.com/attachments/835877241292455966/1030533060678123572/unknown.png");
  }
    ...
    message.channel.send("https://tenor.com/view/zyzz-zyzz-dance-gif-24669039");
  }
            if(message.content === "Haha") {
    message.channel.send("https://tenor.com/view/zyzz-zyzz-dance-gif-24669039");
  }
    ...
    message.channel.send("https://tenor.com/view/pussy-cat-uncensored-funny-gif-22745274");
  }
                if(message.content === "Pussy") {
    message.channel.send("https://tenor.com/view/pussy-cat-uncensored-funny-gif-22745274");
  }
                  if(message.content === "Uncensored pussy") {
    message.channel.send("https://tenor.com/view/pussy-cat-uncensored-funny-gif-22745274");
  }
                    if(message.content === "uncensored pussy") {
    message.channel.send("https://tenor.com/view/pussy-cat-uncensored-funny-gif-22745274");
                      ...
                      if(message.content === "Censored pussy") {
    message.channel.send("https://tenor.com/view/censured-cat-meme-anime-pussy-gif-23805792");
  }
                        if(message.content === "censored pussy") {
    message.channel.send("https://tenor.com/view/censured-cat-meme-anime-pussy-gif-23805792");
  }
    ...
    message.channel.send("https://tenor.com/view/aot-grisha-yeager-attack-on-titan-attack-on-titan-season4part2-attack-on-titan-season4-gif-24707101");
  }
                            if(message.content === "Triggered") {
    message.channel.send("https://tenor.com/view/aot-grisha-yeager-attack-on-titan-attack-on-titan-season4part2-attack-on-titan-season4-gif-24707101");
  }
    ...
    message.channel.send("https://tenor.com/view/floch-forester-floch-forster-floch-attack-on-titan-aot-gif-20657725");
  }
                                if(message.content === "Shhh") {
    message.channel.send("https://tenor.com/view/floch-forester-floch-forster-floch-attack-on-titan-aot-gif-20657725");
  }
    ...
    message.channel.send("https://tenor.com/view/fate-heavens-feel3-heavens-feel3-saber-saber-alter-saber-alter-excalibur-gif-21281585");
  }
                                  if(message.content === "Excalibur") {
    message.channel.send("https://tenor.com/view/fate-heavens-feel3-heavens-feel3-saber-saber-alter-saber-alter-excalibur-gif-21281585");
  }
                                    if(message.content === "cry about it") {
    message.channel.send("https://tenor.com/view/fate-fsn-fate-stay-night-heavens-feel-heavens-feel3-gif-21008061");
  }
                                      if(message.content === "Cry about it") {
    message.channel.send("https://tenor.com/view/fate-fsn-fate-stay-night-heavens-feel-heavens-feel3-gif-21008061");
  }
    ...
    message.channel.send("https://tenor.com/view/saber-eating-bread-ubw-fate-gif-19103530");
  }
       if(message.content === "Saber") {
    message.channel.send("https://tenor.com/view/saber-eating-bread-ubw-fate-gif-19103530");
  }
      if(message.content === "more saber") {
    message.channel.send("https://tenor.com/view/anime-saber-lily-cute-happy-gif-12220384");
  }
   if(message.content === "More saber") {
    message.channel.send("https://tenor.com/view/anime-saber-lily-cute-happy-gif-12220384");
  }
  if(message.content === "addition saber") {
    message.channel.send("https://tenor.com/view/anime-todays-menu-for-emiya-family-food-gif-13451468");
  }
  if(message.content === "Addition saber") {
    message.channel.send("https://tenor.com/view/anime-todays-menu-for-emiya-family-food-gif-13451468");
  }
                                            ...
                                            if(message.content === "💀") {
    message.channel.send("https://tenor.com/view/skeletons-berserk-roast-skeleton-gif-25184374");
  }
                                              if(message.content === "ankle") {
    message.channel.send("https://cdn.discordapp.com/attachments/835872506916765720/970603596112621579/unknown.png");
  }
  if(message.content === "B") {
    message.channel.send("https://media.discordapp.net/attachments/873018389721911347/935579302228033556/RDT_20220126_0056233106098587236348102.gif");
  }
   ...
   if(message.content === "no") {
    message.channel.send("https://tenor.com/view/hibike-euphonium-nope-nope-nope-run-away-anime-kumiko-oumae-gif-15989481");
  }
  if(message.content === "No") {
    message.channel.send("https://tenor.com/view/hibike-euphonium-nope-nope-nope-run-away-anime-kumiko-oumae-gif-15989481");
  }
  ...
  if(message.content === "horny") {
    message.channel.send("https://cdn.discordapp.com/attachments/820950032798711839/893467249539710996/ina_bonk.gif");
  }
  if(message.content === "Horny") {
    message.channel.send("https://cdn.discordapp.com/attachments/820950032798711839/893467249539710996/ina_bonk.gif");
  }
  ...
  if(message.content === "vc") {
    message.channel.send("https://tenor.com/view/join-vc-voice-chat-voice-discord-saber-gif-24970836");
  }
  if(message.content === "Vc") {
    message.channel.send("https://tenor.com/view/join-vc-voice-chat-voice-discord-saber-gif-24970836");
  }
  if(message.content === "vcvc") {
    message.channel.send("https://tenor.com/view/join-vc-voice-chat-voice-discord-saber-gif-24970836");
  }
  if(message.content === "Vcvc") {
    message.channel.send("https://tenor.com/view/join-vc-voice-chat-voice-discord-saber-gif-24970836");
  ...
  if(message.content === "tusk act 4") {
    message.channel.send("https://tenor.com/view/jojo-jjba-johnnyjoestar-sbr-steelballrun-gif-18601118");
  }
  if(message.content === "spin cj ball") {
    message.channel.send("https://tenor.com/view/tusk-act4-jonnhy-joestar-jojo-gif-20478113");
  }
  if(message.content === "spinning cj") {
    message.channel.send("https://tenor.com/view/reimu-touhou-spinning-gif-22015649");
  }
...
client.on("messageCreate", message => {
  ...
  if(message.content === "sex") {
    message.channel.send("https://cdn.discordapp.com/attachments/826924379853160449/960835034833621043/e42cfa8ac5464ff68460fd2108c8ab96.mp4");
  }
  if(message.content === "dyin") {
    message.channel.send("https://cdn.discordapp.com/attachments/826924379853160449/955468520358031390/Reimu_dies_at_a_rave_party.mp4");
  }
})
...
client.on("messageCreate", message => {
  if(message.content === "whatever") {
   ...
   if(message.content === "?") {
    ...
    message.channel.send("'idk', i see. So you built up the energy to reply nothing other than 'idk'. Out of all the things you could've replied, you just went 'idk' . Wow. Fuck you dipshit. This is not 'idk' . Dont think this is even funny. Even a feminist comedian is funnier than is shit. i sat and typed a proper message, I put time and thought into it and you jizz all over it by posting the two letter message 'idk'. You did not take one bit of my message into consideration, you just replied that without the intention of contributing to the conversation. I cant believe that you're this stupid. I do NOT waste my time when i write messages. YOU did, you took 5 second out of your life just to say 'idk' and piss me off. You fucking piece of shit. I hope you die alone in pain. You're an absolute disgrace to humanity and you know it. im amazed you even have friends. They must be assholes who spend all their time replying 'idk' to proper messages too. Now find something else to do with your life. You're fucking dead, 'idk' iddo. (I am a bot, and this action was performed automatically. Please contact yp the moderators of this sub if you have any questions or concerns.) ");
  }
        if(message.content === "Idk") {
    message.channel.send("'idk', i see. So you built up the energy to reply nothing other than 'idk'. Out of all the things you could've replied, you just went 'idk' . Wow. Fuck you dipshit. This is not 'idk' . Dont think this is even funny. Even a feminist comedian is funnier than is shit. i sat and typed a proper message, I put time and thought into it and you jizz all over it by posting the two letter message 'idk'. You did not take one bit of my message into consideration, you just replied that without the intention of contributing to the conversation. I cant believe that you're this stupid. I do NOT waste my time when i write messages. YOU did, you took 5 second out of your life just to say 'idk' and piss me off. You fucking piece of shit. I hope you die alone in pain. You're an absolute disgrace to humanity and you know it. im amazed you even have friends. They must be assholes who spend all their time replying 'idk' to proper messages too. Now find something else to do with your life. You're fucking dead, 'idk' iddo. (I am a bot, and this action was performed automatically. Please contact yp the moderators of this sub if you have any questions or concerns.) ");
  }
  ...
  if(message.content === "?help") {
    message.channel.send("valo, Valo, mou valo, haha, Haha, pussy, Pussy, Uncensored pussy, uncensored pussy, Censored pussy, censored pussy, triggered, Triggered, shhh, Shhh, excalibur, Excalibur, cry about it, Cry about it, tusk act 4, spin cj ball, spinning cj, no, No, nope, Nope, horny, Horny, bonk, Bonk, vc, Vc, vcvc, Vcvc");
  }
  ...
  if(message.content === "lean") {
    message.channel.send("It's literally just cola you piece of shit. There's no cough syrup or anything. What the fuck is wrong with you. How fucking desperate are you to seem cool that you decide you want to force a `joke` about a child consuming drugs. Which would be funny except nothing in this scene implies that they're doing drugs or a drug stand-in. You just saw a can of soda and the two neurons in your head fired for the first time in a week, and you jumped into the comments to screech lEAn and spam purple emojis like a clown bastard. You people are the reason art is dying. Fuck you. (I am a bot, and this action was performed automatically. Please contact yp the moderators of this sub if you have any questions or concerns.)");
      }
...
// })  
 ...
 if(message.content === "shit") {
  ...
  if(message.content === "hentai") {
    message.channel.send("she just blinking what an actual fuck are you on inputing `hentai` in the sub? how desparating you are? get some bible and go outside touches grass already.(I am a bot, and this action was performed automatically. Please contact yp the moderators of this sub if you have any questions or concerns.)");
  }
  if(message.content === "Hentai") {
    message.channel.send("she just blinking what an actual fuck are you on inputing `Hentai` in the sub? how desparating you are? get some bible and go outside touches grass already.(I am a bot, and this action was performed automatically. Please contact yp the moderators of this sub if you have any questions or concerns.)");
  }
...
/*
         if(message.content === "cj") {
    message.channel.send("that hoe took away my cj.That fucking piece shit took every single thing from me, hence by that i never ever talk to people anymore because of her, She ruin my life. Im so fucking sad. (I am a bot, and this action was performed automatically. Please contact yp the moderators of this sub if you have any questions or concerns.)");
  }
            if(message.content === "chan") {
    message.channel.send("that hoe took away my chan.That fucking piece shit took every single thing from me, hence by that i never ever talk to people anymore because of her, She ruin my life. Im so fucking sad. (I am a bot, and this action was performed automatically. Please contact yp the moderators of this sub if you have any questions or concerns.)");
  }
              if(message.content === "joel") {
    message.channel.send("smart ass average bio lover. (I am a bot, and this action was performed automatically. Please contact yp the moderators of this sub if you have any questions or concerns.)");
  }
               if(message.content === "yp") {
    message.channel.send("that hoe took away my yp.That fucking piece shit took every single thing from me, hence by that i never ever talk to people anymore because of her, She ruin my life. Im so fucking sad. (I am a bot, and this action was performed automatically. Please contact yp the moderators of this sub if you have any questions or concerns.)");
  }
                if(message.content === "brad") {
    message.channel.send("that hoe took away my brad.That fucking piece shit took every single thing from me, hence by that i never ever talk to people anymore because of her, She ruin my life. Im so fucking sad. (I am a bot, and this action was performed automatically. Please contact yp the moderators of this sub if you have any questions or concerns.)");
  }
                  if(message.content === "hoe") {
    message.channel.send("you are a bigger hoe than ong chern hoe you hoe. (I am a bot, and this action was performed automatically. Please contact yp the moderators of this sub if you have any questions or concerns.)");
  }
                    if(message.content === "Hoe") {
    message.channel.send("you are a bigger hoe than ong chern hoe you hoe. (I am a bot, and this action was performed automatically. Please contact yp the moderators of this sub if you have any questions or concerns.)");
  }
*/
            ...
            if(message.content === "genshin") {
    message.channel.send("This is fucking terrible. Genshin is a good game. We are not pedophiles. We are not obese. We dont care about bitches. Most of us arent fatherless. Blame the league of legend players for this shit not us. (I am a bot, and this action was performed automatically. Please contact yp the moderators of this sub if you have any questions or concerns.)");
  }
              if(message.content === "Genshin") {
    message.channel.send("This is fucking terrible. Genshin is a good game. We are not pedophiles. We are not obese. We dont care about bitches. Most of us arent fatherless. Blame the league of legend players for this shit not us. (I am a bot, and this action was performed automatically. Please contact yp the moderators of this sub if you have any questions or concerns.)");
  }
                if(message.content === "cursed") {
    message.channel.send("This is fucking terrible. Genshin is a good game. We are not pedophiles. We are not obese. We dont care about bitches. Most of us arent fatherless. Blame the league of legend players for this shit not us. (I am a bot, and this action was performed automatically. Please contact yp the moderators of this sub if you have any questions or concerns.)");
  }
                  if(message.content === "Cursed") {
    message.channel.send("This is fucking terrible. Genshin is a good game. We are not pedophiles. We are not obese. We dont care about bitches. Most of us arent fatherless. Blame the league of legend players for this shit not us. (I am a bot, and this action was performed automatically. Please contact yp the moderators of this sub if you have any questions or concerns.)");
...
// */
    ...
    message.channel.send("dont care plus you didnt asked, go breath trash air, dog water, you entering to my cringe complition, ur dad left, you dress like garbage, ggenshin player, your problem, get a job , not funny didnt laugh. (I am a bot, and this action was performed automatically. Please contact yp the moderators of this sub if you have any questions or concerns.)");
  }
                  if(message.content === "What") {
    message.channel.send("dont care plus you didnt asked, go breath trash air, dog water, you entering to my cringe complition, ur dad left, you dress like garbage, ggenshin player, your problem, get a job , not funny didnt laugh. (I am a bot, and this action was performed automatically. Please contact yp the moderators of this sub if you have any questions or concerns.)");
  }
